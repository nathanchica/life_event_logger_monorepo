...
vi.mock('../../LoggableEvents/LoggableEventsList', () => ({
    default: function MockLoggableEventsList({ searchTerm }) {
        return (
...
vi.mock('../../EventCards/CreateEventCard', () => ({
    default: function MockCreateEventCard() {
        return <div data-testid="create-event-card">Create Event Card</div>;
    }
}));

vi.mock('../../Sidebar/Sidebar', () => ({
    default: function MockSidebar({ isCollapsed, onCollapseSidebarClick }) {
        return (
