...
vi.mock('@mui/material/ClickAwayListener', () => ({
    default: function MockClickAwayListener({ children, onClickAway }) {
        return (
            <>
...
// Mock EventLabelList
vi.mock('../../EventLabels/EventLabelList', () => ({
    default: function MockEventLabelList({ isShowingEditActions }) {
        return (
...
const { mockLogoutMutation } = vi.hoisted(() => {
    return {
...
describe('Sidebar', () => {
    let user;
    const mockOnCollapseSidebarClick = vi.fn();
