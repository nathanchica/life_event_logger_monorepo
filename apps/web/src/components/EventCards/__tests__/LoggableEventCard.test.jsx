...
vi.mock('../EditEventCard', () => ({
    default: function MockEditEventCard({ onDismiss }) {
        return (
...
describe('LoggableEventCard', () => {
    let apolloCache;
    let user;
    const mockAddTimestampToEvent = vi.fn();
    const mockDeleteLoggableEvent = vi.fn();
    ...
    beforeEach(() => {
        vi.useFakeTimers();
        vi.setSystemTime(parseISO('2025-01-10')); // Set a fixed date for testing
